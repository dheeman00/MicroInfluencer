...
%% 100M from Top 1000M (with actual total followers from the sample 100M)
fidTop_100M_country = fopen('./DistanceMatrixSamples/JoinResults_WithActualMin/NewJS_100M_.csv');
dataTop_100M_country = cell2mat(textscan(fidTop_100M_country,'','headerlines',0,'delimiter',',','collectoutput',1));
data_upper_100M_country = triu(dataTop_100M_country, 1);
%labelTop = readtable('./DistanceMatrixTopUsers/TopFollowerLabelsUpdated.csv');
labelTop_100M_country = readtable('./DistanceMatrixSamples/SamplingCountFollowers/TopFollowerLabels_Samples_100M.csv');
...
CombinedMatrix_S7_100M_alt_country = data_upper_100M_country;
...
CombinedMatrix_100M_country = CombinedMatrix_S7_100M_alt_country(1:1005, 1:1005);

% % tsne plot barneshut
T_sne_100M_country = tsne(CombinedMatrix_100M_country,'Algorithm','exact','Distance','cosine');
...
tSNE_100M_alt_country = T_sne_100M_country(1:1005,:);
tSNE_table_100M_country = array2table(tSNE_100M_alt_country, 'VariableNames', {'C1', 'C2'});
tSNE_table_100M_country.Category = labelTop_100M_country.('Category');
tSNE_table_100M_country.Country = labelTop_100M_country.('Country');
tSNE_table_100M_country.Language = labelTop_100M_country.('Language');
tSNE_table_100M_country.screen_name = labelTop_100M_country.('users');


writetable(tSNE_table_100M_country,'tSNE_table_100M_country_CountrySpecific.csv','Encoding','UTF-8');

% % country label
Argentina_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Argentina'), :);
Australia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Australia'), :);
Brazil_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Brazil'), :);
Canada_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Canada'), :);
Chile_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Chile'), :);
China_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'China'), :);
Colombia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Colombia'), :);
Dominican_Republic_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Dominican Republic'), :);
Egypt_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Egypt'), :);
ElSalvador_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'El Salvador'), :);
France_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'France'), :);
Germany_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Germany'), :);
Guatemala_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Guatemala'), :);
HongKong_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Hong Kong'), :);
India_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'India'), :);
Indonesia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Indonesia'), :);
Ireland_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Ireland'), :);
Italy_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Italy'), :);
Jamaica_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Jamaica'), :);
Japan_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Japan'), :);
Jordan_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Jordan'), :);
Kuwaiti_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Kuwaiti'), :);
Lebanon_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Lebanon'), :);
Mexico_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Mexico'), :);
Netherlands_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Netherlands'), :);
NewZealand_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'New Zealand'), :);
Nigeria_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Nigeria'), :);
Pakistan_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Pakistan'), :);
Philippines_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Philippines'), :);
PuertoRico_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Puerto Rico'), :); 
Qatar_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Qatar'), :); 
Russia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Russia'), :); 
SaudiArabia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Saudi Arabia'), :); 
Serbia_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Serbia'), :); 
SouthAfrica_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'South Africa'), :); 
SouthKorea_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'South Korea'), :); 
Spain_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Spain'), :); 
Sweden_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Sweden'), :); 
Switzerland_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Switzerland'), :); 
Thailand_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Thailand'), :); 
Turkey_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Turkey'), :); 
UAE_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'UAE'), :); 
UnitedKingdom_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'United Kingdom'), :); 
UnitedStates_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'United States'), :); 
Uruguay_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Uruguay'), :); 
VaticanCity_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Vatican City'), :); 
Venezuela_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Venezuela'), :); 
Zimbabwe_100M = tSNE_table_100M_country(strcmp(tSNE_table_100M_country.Country, 'Zimbabwe'), :); 

% % sample with labels
% tSNE_S7_100M_alt_country = T_sne_100M_country(1006:1105,:);
...
labelpoints(tSNE_table_100M_country.C1,tSNE_table_100M_country.C2,tSNE_table_100M_country.screen_name, ...
'C',0.025, 1, 'FontSize', 1.25,  'rotation', 0,  'Color', 'k'); % location label 'SE' % note: C represents much better
title(leg1,'Countries');
grid off;
hold off;
print(gcf,'tSNE_Country_TopFollowers.png','-dpng','-r1300');
