...
data_upper_100M = triu(data_upper_100M, 1);
[numRowsTop,numColsTop] = size(dataTop_tweets_alt);
...
fid_S6_100M = fopen('./DistanceMatrixSamples/SampleV3_6_New_JS/Sample_6_NewJS_WithActualMin/Sample_6_NewJS_WithActualMin_100M_.csv');
dataSample_S6_100M = cell2mat(textscan(fid_S6_100M,'','headerlines',0,'delimiter',',','collectoutput',1));
[numRowsSample,numColsSample] = size(dataSample_S6_100M);
label_file_link_S6 = strcat('./DistanceMatrixSamples/ExtractedSamplesV3_Labels/Label_Sample_',str_num,'_With_Country_Lang_ID_updated_newV2.csv');
label_S6 = readtable(label_file_link_S6);

fclose('all');

CombinedMatrix_S6_100M_alt = data_upper_100M;
CombinedMatrix_S6_100M_alt(1006:1125,1:1005) = dataSample_S6_100M';
CombinedMatrix_S6_100M_alt(1:1005,1006:1125) = dataSample_S6_100M;
for i = 1:1125
    for j = i+1:1125
        CombinedMatrix_S6_100M_alt(j,i) = CombinedMatrix_S6_100M_alt(i,j);
    end
    CombinedMatrix_S6_100M_alt(i,i) = 1;
end


% tsne plot
T_sne_100M_S6 = tsne(CombinedMatrix_S6_100M_alt,'Algorithm','exact','Distance','cosine');
% % extract data (Top Followers)
tSNE_100M_alt = T_sne_100M_S6(1:1005,:);
...
writetable(tSNE_table_100M,'tSNE_table_100M_S6_1.csv','Encoding','UTF-8');

% % sample-7 with labels
tSNE_S6_100M_alt = T_sne_100M_S6(1006:1125,:);

tSNE_table_S6_100M_alt = array2table(tSNE_S6_100M_alt, 'VariableNames', {'C1', 'C2'});
tSNE_table_S6_100M_alt.Category = label_S6.('Category');
tSNE_table_S6_100M_alt.Country = label_S6.('Country');
tSNE_table_S6_100M_alt.Language = label_S6.('Language');
tSNE_table_S6_100M_alt.screen_name = label_S6.('screen_name');

writetable(tSNE_table_S6_100M_alt,'tSNE_table_100M_S6_2.csv','Encoding','UTF-8');

% Unlabelled_S6_100M_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Unlabeled'), :);

%% country label (TopFollowers)
...
%% country label (MicroInfluencer)
Canada_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Canada'), :);
Cuba_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Cuba'), :);
Denmark_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Denmark'), :);
France_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'France'), :);
India_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'India'), :);
Indonesia_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Indonesia'), :);
Italy_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Italy'), :);
Japan_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Japan'), :);
Kosovo_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Kosovo'), :);
Kuwaiti_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Kuwaiti'), :);
Malta_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Malta'), :);
Mexico_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Mexico'), :);
Netherlands_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Netherlands'), :);
PuertoRico_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Puerto Rico'), :);
Seychelles_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Seychelles'), :);
Singapore_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Singapore'), :);
SouthAfrica_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'South Africa'), :);
SouthKorea_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'South Korea'), :); 
Spain_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'Spain'), :);
UnitedKingdom_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'United Kingdom'), :);
UnitedStates_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Country, 'United States'), :);

% % color code (Country Samples):
% Cuba - Russet - #80461b
% Denmark - Coquelicot - #ff3800
% Kosovo - Golden Yellow - #ffdf00
% Malta - Peach - #ffe5ad
% Seychelles - New Orleans - #f2dea4
% Singapore - Yellow Chartreuse - #dfff00


% % color code (Country both Top Followers and Samples):
...
%figure('units','inch','position',[20,15,20,15]); % this is a good fit size for the window
...
hold on;
% include the sample dataset
p49 = plot(Canada_S6.C1, Canada_S6.C2, 'o', 'Color' ,'#e97451', 'MarkerSize', 5); 
hold on;
p50 = plot(Cuba_S6.C1, Cuba_S6.C2, 'o', 'Color' ,'#80461b', 'MarkerSize', 5); 
hold on;
p51 = plot(Denmark_S6.C1, Denmark_S6.C2, 'o', 'Color' ,'#ff3800', 'MarkerSize', 5); 
hold on;
p52 = plot(France_S6.C1, France_S6.C2, 'o', 'Color' ,'#004225', 'MarkerSize', 5); 
hold on;
p53 = plot(India_S6.C1, India_S6.C2, 'o', 'Color' ,'#bf00ff', 'MarkerSize', 5); 
hold on;
p54 = plot(Indonesia_S6.C1, Indonesia_S6.C2, 'o', 'Color' ,'#c54b8c', 'MarkerSize', 5); 
hold on;
p55 = plot(Italy_S6.C1, Italy_S6.C2, 'o', 'Color' ,'#c71585', 'MarkerSize', 5); 
hold on;
p56 = plot(Japan_S6.C1, Japan_S6.C2, 'o', 'Color' ,'#8f8b66', 'MarkerSize', 5); 
hold on;
p57 = plot(Kosovo_S6.C1, Kosovo_S6.C2, 'o', 'Color' ,'#ffdf00', 'MarkerSize', 5); 
hold on;
p58 = plot(Kuwaiti_S6.C1, Kuwaiti_S6.C2, 'o', 'Color' ,'#000080', 'MarkerSize', 5); 
hold on;
p59 = plot(Malta_S6.C1, Malta_S6.C2, 'o', 'Color' ,'#ffe5ad', 'MarkerSize', 5); 
hold on;
p60 = plot(Mexico_S6.C1, Mexico_S6.C2, 'o', 'Color' ,'#00ffff', 'MarkerSize', 5); 
hold on;
p61 = plot(Netherlands_S6.C1, Netherlands_S6.C2, 'o', 'Color' ,'#cc5500', 'MarkerSize', 5); 
hold on;
p62 = plot(PuertoRico_S6.C1, PuertoRico_S6.C2, 'o', 'Color' ,'#ff6347', 'MarkerSize', 5); 
hold on;
p63 = plot(Seychelles_S6.C1, Seychelles_S6.C2, 'o', 'Color' ,'#f2dea4', 'MarkerSize', 5); 
hold on;
p64 = plot(Singapore_S6.C1, Singapore_S6.C2, 'o', 'Color' ,'#dfff00', 'MarkerSize', 5); 
hold on;
p65 = plot(SouthAfrica_S6.C1, SouthAfrica_S6.C2, 'o', 'Color' ,'#2e8b57', 'MarkerSize', 5); 
hold on;
p66 = plot(SouthKorea_S6.C1, SouthKorea_S6.C2, 'o', 'Color' ,'#006400', 'MarkerSize', 5); 
hold on;
p67 = plot(Spain_S6.C1, Spain_S6.C2, 'o', 'Color' ,'#addfad', 'MarkerSize', 5); 
hold on;
p68 = plot(UnitedKingdom_S6.C1, UnitedKingdom_S6.C2, 'o', 'Color' ,'#58111a', 'MarkerSize', 5); 
hold on;
p69 = plot(UnitedStates_S6.C1, UnitedStates_S6.C2, 'o', 'Color' ,'#cf352e', 'MarkerSize', 5); 
...
h = [p1(1), p2, p3(1), p4, p5(1), p6, p7(1), p8, p9(1), p10, p11(1), p12, p13(1), ...
    ...
    p50, p51(1), p52, p53(1), p54, p55(1), p56, p57(1), p58, p59(1), p59, p60(1), ...
    p61, p62(1), p63, p64(1), p65, p66(1), p67, p68(1), p69];
hold off;
...
leg1 = legend(h,'Argentina', 'Australia','Brazil', 'Canada', 'Chile', 'China', 'Colombia', ...
        ...
        'Canada', 'Cuba', 'Denmark', 'France', 'India', 'Indonesia', 'Italy', 'Japan', 'Kosovo', ...
        'Kuwaiti', 'Malta', 'Mexico', 'Netherlands', 'Puerto Rico', 'Seychelles', 'Singapore', ...
        'South Africa', 'South Korea', 'Spain', 'United Kingdom', 'United States', ...
        'Location','northeastoutside', 'FontSize', 8.5);
...
labelpoints(tSNE_table_S6_100M_alt.C1,tSNE_table_S6_100M_alt.C2,tSNE_table_S6_100M_alt.screen_name, ...
'C',0.025, 1, 'FontSize', 1.25,  'rotation', 0,  'Color', 'k'); % location label 'SE' % note: C represents much better
title(leg1,'Country');
grid off;

%print(gcf,'tSNE_Country_TopFollowers_S6_labelled.png','-dpng','-r1300');

%% plot using the Category (Top Followers)
...
%% plot using the Category (Samples)
Entertainment_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Entertainment'), :);
Corporate_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Corporate/Company'), :);
News_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'News/Media'), :);
Politics_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Politics'), :);
%Religion_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Religion'), :);
Sports_S6_alt = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Category, 'Sports'), :);
...
hold on;
p7 = plot(Entertainment_S6_alt.C1, Entertainment_S6_alt.C2, 'o','Color' ,'r', 'MarkerSize',5);
hold on;
p8 = plot(Corporate_S6_alt.C1, Corporate_S6_alt.C2, 'o','Color' ,'k', 'MarkerSize',5);
hold on;
p9 = plot(News_S6_alt.C1, News_S6_alt.C2, 'o','Color' ,'g', 'MarkerSize',5);
hold on;
p10 = plot(Politics_S6_alt.C1, Politics_S6_alt.C2, 'o','Color' ,'b', 'MarkerSize',5);
hold on; 
p11 = plot(Sports_S6_alt.C1, Sports_S6_alt.C2, 'o','Color' ,'m', 'MarkerSize',5);
hold on;
labelpoints(tSNE_table_100M.C1,tSNE_table_100M.C2,tSNE_table_100M.screen_name, ...
...
leg1 = legend(h,'Entertainment','Corporate/Company','News/Media','Politics', 'Religion', 'Sports', ...
    'Entertainment','Corporate/Company','News/Media','Politics', 'Sports', ...
    'Location','northeast','FontSize', 12);
title(leg1,'Category');
hold off;
%print(gcf,'tSNE_Category_TopFollowers_S6_labelled.png','-dpng','-r1300');

%% language label (Top Followers)
...
Arabic_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Arabic'), :);
Dutch_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Dutch'), :);
English_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'English'), :);
Indonesian_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Indonesian'), :);
Italian_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Italian'), :);
Japanese_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Japanese'), :);
Portuguese_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Portuguese'), :);
Spanish_S6 = tSNE_table_S6_100M_alt(strcmp(tSNE_table_S6_100M_alt.Language, 'Spanish'), :);
...
hold on;
% samples
p21 = plot(Arabic_S6.C1, Arabic_S6.C2, 'o','Color' ,'r', 'MarkerSize',5);
hold on;
p22 = plot(Dutch_S6.C1, Dutch_S6.C2, 'o','Color' ,'#ffe5ad', 'MarkerSize',5);
hold on;
p23 = plot(English_S6.C1, English_S6.C2, 'o','Color' ,'g', 'MarkerSize',5);
hold on; 
p24 = plot(Indonesian_S6.C1, Indonesian_S6.C2, 'o','Color' ,'#808000', 'MarkerSize',5);
hold on;
p25 = plot(Italian_S6.C1, Italian_S6.C2, 'o','Color' ,'#35281E', 'MarkerSize',5);
hold on;
p26 = plot(Japanese_S6.C1, Japanese_S6.C2, 'o','Color' ,'#551a8b', 'MarkerSize',5);
hold on;
p27 = plot(Portuguese_S6.C1, Portuguese_S6.C2, 'o','Color' ,'#00bfff', 'MarkerSize',5);
hold on;
p28 = plot(Spanish_S6.C1, Spanish_S6.C2, 'o','Color' ,'#d0f0c0', 'MarkerSize',5);

h = [p1(1); p2; p3(1); p4; p5(1); p6;p7(1);p8;p9(1);p10; ... 
    p11(1);p12;p13(1);p14;p15(1);p16;p17(1);p18;p19(1);p20;p21(1); ...
    p22; p23(1); p24; p25(1); p26(1); p27; p28(1)];
title('\rm 100 Millions Sampled Users from Top Followers in Twitter with Micro-Influencer Samples', 'FontSize', 18);
labelpoints(tSNE_table_100M.C1,tSNE_table_100M.C2,tSNE_table_100M.screen_name, ...
'C',0.025, 1, 'FontSize', 1.25,  'rotation', 0,  'Color', 'k'); % location label 'SE' % note: C represents much better
labelpoints(tSNE_table_S6_100M_alt.C1,tSNE_table_S6_100M_alt.C2,tSNE_table_S6_100M_alt.screen_name, ...
...
leg1 = legend(h,'Arabic','Catalan','English','Filipino', 'French', 'German', ...
    ...
    'Arabic', 'Dutch', 'English', 'Indonesian', 'Italian', 'Japanese', 'Portuguese', 'Spanish', ...
    'Location','northeastoutside', 'FontSize', 12);
title(leg1,'Language');
grid off;
hold off;
%print(gcf,'tSNE_Language_TopFollowers_S6_labelled.png','-dpng','-r1300');
